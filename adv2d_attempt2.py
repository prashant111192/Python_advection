...
def main():
    ...
    ini_plot = ax1.scatter(particle_coords[:,0], particle_coords[:,1], c=ConcOrig, s = (ConcOrig*100))
    ax1.set_title("Initial concentration")
    ax1.set_ylim(-0.01,0.01)
    plt.colorbar(ini_plot, ax=ax1)
    ax1.grid()
    Final_plot = ax2.scatter(particle_coords[:,0], particle_coords[:,1], c=Conc, s = Conc*100)
    ...
    plt.clf()
    plt.plot(particle_coords[middle_particles,0].T, ConcOrig[middle_particles], 'r*',markevery = 10, label="Initial", fillstyle='none' )
    plt.plot(particle_coords[middle_particles,0].T, Conc_CD[middle_particles],'b*', markevery=10, label="CD", fillstyle='none')
    plt.plot(particle_coords[middle_particles,0].T, Conc[middle_particles],'b:', label="Final")
    plt.plot(particle_coords[middle_particles,0].T, Conc_UP[middle_particles],'b^', markevery=12, label="UP", fillstyle='none')
    plt.ylim(-0.1,1.1)
    ...
    plt.clf()
    plt.plot(particle_coords[middle_particles,0].T, ConcOrig[middle_particles], 'r*',markevery = 10, label="Initial", fillstyle='none' )
    plt.plot(particle_coords[middle_particles,0].T, Conc_N_CD[middle_particles],'g*', markevery=10, label="CD_N", fillstyle='none')
    plt.plot(particle_coords[middle_particles,0].T, Conc_N_SPH[middle_particles],'g:', label="Final_N")
    plt.plot(particle_coords[middle_particles,0].T, Conc_N_UP[middle_particles],'g^', markevery=12, label="UP_N", fillstyle='none')
    plt.ylim(-0.1,1.1)
    plt.title("Concentration along the middle line")
    plt.xlabel("x position")
    plt.ylabel("Concentration")
    ...
    np.savetxt("ConcOrig.csv", np.array(particle_coords[middle_particles,0].T,ConcOrig[middle_particles]), delimiter=",")
